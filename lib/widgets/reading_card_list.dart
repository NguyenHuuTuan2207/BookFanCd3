...
class ReadingListCard extends StatelessWidget {
  ...
  const ReadingListCard({
    ...
    required this.image, // Mark as required
    required this.title, // Mark as required
    required this.auth, // Mark as required
    required this.rating, // Mark as required
    required this.pressDetails, // Mark as required
    required this.pressRead, // Mark as required
  }) : super(key: key);
